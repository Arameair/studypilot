...
type Application interface {
	...
	GetModuleWorkspace(context.Context, application.ModuleWorkspaceRequest) (application.ModuleWorkspaceResult, error)
	InspectModuleSessions(context.Context, application.InspectModuleRequest) (application.SessionScanResult, error)
	CreateSession(context.Context, application.CreateSessionRequest) (application.SessionResult, error)
