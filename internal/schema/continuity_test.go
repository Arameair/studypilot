...
func TestProjectContinuityDocuments(t *testing.T) {
	required := map[string][]string{
		...
		"local-capture.md":                     {"# Local Audio Capture", "## Architecture", "## Validated utility and driver", "## Configuration", "## Fixed process arguments", "## WAV format", "## Lifecycle", "## Cancellation", "## Failure behavior", "## Recovery", "## Capability discovery", "## Operational validation", "## Privacy and limitations"},
	}
